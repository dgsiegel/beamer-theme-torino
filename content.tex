...
\item Read the example files
  ...
  \item \verb!skyblue.tex!: blue tango theme, watermark and squares for bullet lists
  \end{itemize}
\end{itemize}
\end{frame}
...
\item Color themes define the colors to be used in outer and inner themes
  \begin{itemize}
    ...
    \item \verb!beamercolorthemefreewilly.sty!: blue footers, headers and
          frame title
    \item \verb!beamercolorthemeskyblue.sty!: blue footers and headers
  \end{itemize}
...
\item Color themes can be changed with \verb!\usecolortheme!
  ...
  \item \verb!\usecolortheme{skyblue}!: tango blue
  \end{itemize}
